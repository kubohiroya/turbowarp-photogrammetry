...
function checkPolicy() {
  ...
  if (policy.productName !== 'TurboWarp-Photogrammetry') {
...
function checkPackageMetadata() {
  ...
  if (packageMetadata.repository?.url !== 'git+https://github.com/kubohiroya/turbowarp-photogrammetry.git') {
    errors.push('package.json repository.url must point to the current repository');
  }
  if (packageMetadata.bugs?.url !== 'https://github.com/kubohiroya/turbowarp-photogrammetry/issues') {
...
function checkReadmes() {
  ...
  if (!readmeJa.startsWith('# TurboWarp-Photogrammetry\n')) {
...
async function checkPackContents() {
  ...
  if (!files.has('dist/photogrammetry.js')) {
